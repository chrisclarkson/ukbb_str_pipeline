...
def count_and_write(bam_file,component_stretch_counts_list,count_list,eh_reps,print_df=False):
...
if args.bam_files is not None:
    ...
    for i in range(len(bam_files)):
        ...
        if os.path.exists(bam_file):
            ...
            eh_reps=extract_vcf_info(bam_file.replace('_realigned.bam','.vcf',))
            print(bam_file)
            count_and_write(bam_file,component_stretch_counts_list,count_list,eh_reps)
        else:
            print(bam_file+' does not exist')
else:
