...
```
-ireads="Matteo_Pietro:/Bulk/Whole\ genome\ sequences/Whole\ genome\ CRAM\ files/12/123456_12345_0_0.cram" 
-isex=male 
-ioutput_prefix=123456  
...
```
dx run ehv5_multi_original -ireads="Matteo_Pietro:/Bulk/Whole\ genome\ sequences/Whole\ genome\ CRAM\ files/12/123456_12345_0_0.cram" \
	-isex=male -ioutput_prefix=123456  -ireference=GRCh38_full_analysis_set_plus_decoy_hla.fa \
