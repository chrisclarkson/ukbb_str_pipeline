...
library(dplyr)
library(tidyr)
data=data.frame(fread('out.tsv.gz',header=T),stringsAsFactors=F)
...
write.table(out_with_fillers,'500K_icd10_bigger_than_36_all_events2.tsv',sep = '\t',row.names = F,quote=F,na="")
